...
const pill: React.CSSProperties = { display: "inline-flex", alignItems: "center", gap: 8, borderRadius: 999, border: "1px solid rgba(220,38,38,0.3)", background: "rgba(220,38,38,0.1)", padding: "5px 13px", fontSize: 12.5, fontWeight: 500, color: "#fca5a5" };
...
const featIcon: React.CSSProperties = { display: "inline-grid", placeItems: "center", width: 42, height: 42, borderRadius: 11, background: "rgba(220,38,38,0.14)" };
