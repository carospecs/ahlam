...
const lx: Record<string, React.CSSProperties> = {
  ...
  pill: { display: "inline-flex", alignItems: "center", gap: 8, borderRadius: 999, border: "1px solid rgba(220,38,38,0.3)", background: "rgba(220,38,38,0.1)", padding: "5px 12px", fontSize: 12, fontWeight: 500, color: "#fca5a5" },
  ...
  inputWrap: { display: "flex", alignItems: "center", gap: 10, padding: "0 14px", background: "rgba(39,47,66,0.6)", border: "1px solid var(--line)", borderRadius: 12 },
