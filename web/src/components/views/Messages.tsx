...
export function Messages({ go, onVehicle, showDeleted }: { go: (id: string) => void; onVehicle?: (v: any) => void; showDeleted?: boolean }) {
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gridTemplateRows: "minmax(0, 1fr)", height: "100%", minHeight: 380, border: "1px solid var(--line)", borderRadius: "var(--radius-lg)", overflow: "hidden", background: "var(--surface)", maxWidth: 1180 }} className="cs-chat">
      ...
      <div style={{ display: "flex", flexDirection: "column", minWidth: 0, minHeight: 0 }}>
        ...
        <div style={{ flex: 1, minHeight: 0, overflowY: "auto", padding: 18, display: "flex", flexDirection: "column", gap: 12, background: "var(--background)" }}>
