...
- **Wed, LinkedIn (insight):** A specific, slightly contrarian take on how most people get this wrong. Gives the audience something to argue with, which drives reach.
...
- **Wed, LAUNCH (all platforms):** The announcement. LinkedIn gets the long story version, Instagram gets a punchy Reel with the hook up top, Facebook gets the direct conversational version. This is the one promotional spike. Iris produces the actual posts and visuals.
- **Thu, Reel (social proof):** First reactions or an early customer quote. Proof beats claims the day after launch.
- **Fri, carousel (how it works):** Simple walkthrough of the product solving the Week 1 problem. Closes the loop you opened on day one.

**Why this shape works:** Week 1 is almost all value and story with zero hard selling, so by the time the Wednesday launch hits, the audience is primed and the one promotional post lands instead of getting scrolled past. The Reels run as a connected series rather than one-offs, which compounds. And the cadence is one post a day on rotating platforms, sustainable for a small team without burning out.

I'd hand the launch-day captions and images to Iris, pull any trending audio or format Scout flags as hot that week, and check the Week 1 hook rates before locking the Week 2 Reels so we lead with whatever's actually landing.
